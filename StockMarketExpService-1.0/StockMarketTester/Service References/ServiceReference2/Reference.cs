...
namespace StockMarketTester.ServiceReference2 {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference2.IStockExpService")]
    public interface IStockExpService {
        ...
        System.Collections.Generic.List<float> GetValuesfromDB(int highdays, string date);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStockExpService/GetValuesfromDB", ReplyAction="http://tempuri.org/IStockExpService/GetValuesfromDBResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<float>> GetValuesfromDBAsync(int highdays, string date);
        ...
        System.Collections.Generic.List<StockMarketTester.ServiceReference2.StockName> GetComboValuesfromDB();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStockExpService/GetComboValuesfromDB", ReplyAction="http://tempuri.org/IStockExpService/GetComboValuesfromDBResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<StockMarketTester.ServiceReference2.StockName>> GetComboValuesfromDBAsync();
        ...
        System.Collections.Generic.KeyValuePair<float, float> CalCulateAverage(int lowerDay, int highdays, System.Collections.Generic.List<float> dbvalues);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStockExpService/CalCulateAverage", ReplyAction="http://tempuri.org/IStockExpService/CalCulateAverageResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.KeyValuePair<float, float>> CalCulateAverageAsync(int lowerDay, int highdays, System.Collections.Generic.List<float> dbvalues);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IStockExpServiceChannel : StockMarketTester.ServiceReference2.IStockExpService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class StockExpServiceClient : System.ServiceModel.ClientBase<StockMarketTester.ServiceReference2.IStockExpService>, StockMarketTester.ServiceReference2.IStockExpService {
        ...
        public System.Collections.Generic.List<float> GetValuesfromDB(int highdays, string date) {
            return base.Channel.GetValuesfromDB(highdays, date);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<float>> GetValuesfromDBAsync(int highdays, string date) {
            return base.Channel.GetValuesfromDBAsync(highdays, date);
        }
        
        public System.Collections.Generic.List<StockMarketTester.ServiceReference2.StockName> GetComboValuesfromDB() {
            return base.Channel.GetComboValuesfromDB();
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<StockMarketTester.ServiceReference2.StockName>> GetComboValuesfromDBAsync() {
            return base.Channel.GetComboValuesfromDBAsync();
        }
        
        public System.Collections.Generic.KeyValuePair<float, float> CalCulateAverage(int lowerDay, int highdays, System.Collections.Generic.List<float> dbvalues) {
            return base.Channel.CalCulateAverage(lowerDay, highdays, dbvalues);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.KeyValuePair<float, float>> CalCulateAverageAsync(int lowerDay, int highdays, System.Collections.Generic.List<float> dbvalues) {
